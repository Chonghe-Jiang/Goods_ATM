function [solution_adaptive, total_time_adaptive, total_iter_adaptive, obj_adaptive, dis_adaptive] = quasi_dual_adaptive(v, B, mu_0, max_iter, L, sigma, epsilon, mu_lower, mu_upper, delta, plot_flag, adaptive_plot_flag, plot_flag_smooth,  p_opt_solver, fval_solver, adaptive, phase_num)
%%% ! we change the function name :(
