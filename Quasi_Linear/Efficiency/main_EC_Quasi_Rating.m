...
%%% ! Version: EC - Quasi Linear - Rating dataset - Iterative method - Unit budget (every element in B is 1)
%%% ! Work out the linear version first and consider retrain this version!
clc
clear
% Set random seed for reproducibility
% Read the CSV file into a MATLAB matrix
v = readmatrix('C:\Users\s1155203585\Desktop\EG_EXP\Linear\v0_funding_supp\Efficiency\Ratings_kroer.csv');
% v = v/norm(v,"fro");
[n,m] = size(v);
B = ones(n,1);
...
load('C:\Users\s1155203585\Desktop\EG_EXP\Linear\v0_funding_supp\Efficiency\Solver_Rating.mat', 'p_opt_solver', 'beta_opt', 'fval_solver', 'solve_time');
