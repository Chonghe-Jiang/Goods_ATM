...
n = 500;  % Number of rows (buyers)
m = 500;   % Number of columns (goods)
...
eta_initial_pdhg_adaptive = 0.1;    % Initial overall step-size
omega_initial_pdhg_adaptive = 1.0;  % Initial primal-dual weight (1.0 is balanced)
theta_pdhg_adaptive = 0.1;        % Adaptation rate
