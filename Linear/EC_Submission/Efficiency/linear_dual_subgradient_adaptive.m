function [solution, obj_values, dis_sub, time, iter] = linear_dual_subgradient_adaptive(v, B, p0, max_iter, step_size, epsilon, plot_flag, p_opt_solver, fval_solver, switch_step)
    % Adaptive Subgradient Method for solving the linear dual problem.
    %
    % Input:
