%%% EC 2025 Submission
%%% ! Version: EC - Linear - Synthetic Data - Iterative method
...
% Todo: change the epsilon threshold here
max_iter = 25000;
...
if exist(v_filepath, 'file') == 2
    ...
    v = exprnd(10, n, m); % Draw valuations from exponential distribution
    v = v ./ sum(v, 2); % Normalize v
...
eta = 1; % ! Actually no usage here
switch_step = 2000;
[solution_md_adaptive, time_md_adaptive, iter_md_adaptive, obj_values_md_adaptive, distance_md_adaptive] = linear_primal_md_adaptive(v, B, x0, epsilon, max_iter, plot_flag, p_opt_solver, fval_solver, switch_step);
